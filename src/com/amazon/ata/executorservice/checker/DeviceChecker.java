...
//        GetCustomerDevicesResponse response = customerService.getCustomerDevices(request); dont need beause we built the getDeviceIds method in this class that we built
        List<String> deviceIds = getDevicesId(customerId);
        //loop over devices
        for (String deviceId : deviceIds) {
            //create a DeviceCheckTask forEach
    ...
    private List<String> getDevicesId(String customerId) {
        GetCustomerDevicesRequest request = GetCustomerDevicesRequest.builder().withCustomerId(customerId).build();
